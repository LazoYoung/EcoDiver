...
namespace Script.Display
{
    ...
    {
        [Tooltip("Assign the player's transform for default depth size.")]
        private Transform _playerTransform; // Assign the player's transform in the inspector
        ...
        void Start()
        {
            ...
            {
                _defaultDepthLevel = _playerTransform.position.y;
            }
            else
            {
        ...
        void Update()
        {
            if (_playerTransform != null)
            {
                float currentDepth = _defaultDepthLevel - _playerTransform.position.y;
